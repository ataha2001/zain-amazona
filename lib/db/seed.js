...
const { startDb } = require('./connectDb');
...
const main = async () => {
  try {
    ...
    await startDb()
    // await connectToDatabase("mongodb+srv://zain-amazona:ashraf123@cluster0.6zgxtcj.mongodb.net/zain-amazona?retryWrites=true&w=majority&appName=Cluster0")
